...
#LOG7=/youtu-xlab4/choasliu/research/logs/_algo-tanners_r50_caffe_fpn_4x4_lr0.01_b4_2x_coco.py/20200825_202525.log.json

python3 tools/analyze_logs.py plot_curve \
    $LOG3 \
    $LOG5 \
    $LOG6 \
    --keys sub_FCOSHead_loss_cls sub_FCOSHead_loss_bbox sub_FCOSHead_loss_centerness sub_RetinaHead_loss_cls sub_RetinaHead_loss_bbox \
    --out losses.pdf
...
python3 tools/analyze_logs.py plot_curve \
    ...
    $LOG6 \
    --keys bbox_mAP \
    --legend retina fcos tanner1x5e-3.b4 tanner1xe-2.b8 tanner1xe-2.b4 \
    --out mAP.pdf
