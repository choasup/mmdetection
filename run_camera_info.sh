...
LOG_frcn_semi_w1=$ROOT/logs/_sdk-w1-faster_small_r50_fpn_mstrian_eeye_720p_20e_0720_7w_sdk_without_dcn_anchors_semi.py/20200901_011054.log.json
LOG_frcn_semi_w2=$ROOT/logs/_sdk-w2-faster_small_r50_fpn_mstrian_eeye_720p_20e_0720_7w_sdk_without_dcn_anchors_semi.py/20200901_011054.log.json
...
python3 tools/analyze_logs.py plot_curve \
    ...
    $LOG_frcn_semi_w2 \
    --keys bbox_mAP \
    --legend frcn frcn_w2 frcn_roix2 frcn_semi_w1 frcn_semi_w2 \
    --out camera_mAP.pdf
