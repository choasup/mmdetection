...
load_from='/youtu/xlab-team4/choasliu/research/logs/_sdk-w4-faster_small_r50_fpn_mstrian_eeye_720p_20e_0720_7w_sdk_without_dcn_anchors_semi.py/epoch_15.pth'
#'/youtu-xlab4/share/pretrained/checkpoints/semi_12.pth'

# frozen key: pretrained, frozen_stages
model = dict(
    backbone=dict(
