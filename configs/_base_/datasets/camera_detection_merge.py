...
test_data_root = '/youtu/xlab-team4/share/datasets/unlabel_camera/rawdata/data-20200830-183043/'
unlabel_data_root = '/youtu/xlab-team4/share/datasets/unlabel_camera/rawdata/data-20200830-183043/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=unlabel_data_root + 'merge.json',
