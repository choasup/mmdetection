...
from mmdet.models.backbones.efficientnet.utils import MemoryEfficientSwish, Swish
from mmdet.models.backbones.efficientnet.utils_extra import Conv2dStaticSamePadding, MaxPool2dStaticSamePadding
...
class BiFPNBackbone(nn.Module):
    def __init__(self, compound_coef=0, **kwargs):
        super(BiFPNBackbone, self).__init__()
