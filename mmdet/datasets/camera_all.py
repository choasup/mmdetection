...
class CameraDatasetNew(CustomDataset):

    CLASSES = ('camera_gun', 'camera_round', 'camera_other', 'support_w', 'support_h',
               'support_overpass', 'support_dragon', 'support_other', 'support_w_camera_gun',
               'support_w_camera_round', 'support_w_camera_other', 'support_w_camera_gun_valid',
               'support_w_camera_gun_invalid', 'support_w_valid', 'support_w_invalid',
               'camera_gun_support_w', 'camera_gun_support')
            ...
            if metric == 'proposal':
                ...
                if classwise:  # Compute per-category AP
                    ...
                    for idx, catId in enumerate(self.cat_ids):
                        ...
                        str_r = '\n'.join(str(round(x, 2)) for x in r_array[::10])
                        str_s = '\n'.join(str(round(x, 4)) for x in s[::10])
